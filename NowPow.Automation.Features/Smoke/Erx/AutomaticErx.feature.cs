...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("01. Creating Automatic eRx via Patient Profile")]
        [NUnit.Framework.CategoryAttribute("smoke")]
        public virtual void _01_CreatingAutomaticERxViaPatientProfile()
        {
            string[] tagsOfScenario = new string[] {
                    "smoke"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01. Creating Automatic eRx via Patient Profile", null, new string[] {
                        "smoke"});
#line 5
