...
namespace NowPowAutomaiton.Smoke.Erx
{
    ...
    [NUnit.Framework.DescriptionAttribute("ViewErx")]
    public partial class ViewErxFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "ViewErx", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void _01_ViewingERxFromPatientCard()
        {
            string[] tagsOfScenario = new string[] {
                    "smoke"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01.Viewing eRx from Patient Card", null, new string[] {
                        "smoke"});
#line 5
