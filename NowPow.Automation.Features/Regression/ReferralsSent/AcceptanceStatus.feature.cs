...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("01. Verify Referal Sender able to change acceptance status")]
        [NUnit.Framework.CategoryAttribute("regression")]
        public virtual void _01_VerifyReferalSenderAbleToChangeAcceptanceStatus()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01. Verify Referal Sender able to change acceptance status", null, new string[] {
                        "regression"});
#line 5
